...
CREATE TABLE `attend` (
  ...
  `at_co_code` varchar(16) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`at_num`),
  KEY `at_co_code_idx` (`at_st_num`),
  KEY `at_co_code` (`at_co_code`),
...
INSERT INTO `attend` VALUES (1,0,0,0,0,2020110012,'2020_MSC001_1_1');
