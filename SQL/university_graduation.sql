...
CREATE TABLE `graduation` (
  ...
  `gd_is_gd` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `gd_gr_num` varchar(20) COLLATE utf8_bin NOT NULL,
  `gd_st_num` int NOT NULL,
  PRIMARY KEY (`gd_num`),
  KEY `gd_st_num_idx` (`gd_st_num`),
  KEY `gd_gr_num` (`gd_gr_num`),
  CONSTRAINT `gd_gr_num` FOREIGN KEY (`gd_gr_num`) REFERENCES `graduation_requirement` (`gr_num`),
...
INSERT INTO `graduation` VALUES (1,'재학중','졸업요건번호1',2020110011);
